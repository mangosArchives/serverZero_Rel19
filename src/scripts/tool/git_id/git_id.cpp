 ...
 * Copyright (C) 2005-2014 ScriptDev2 <http://www.scriptdev2.com/>
 *
...
char remotes[NUM_REMOTES][MAX_REMOTE] =
{
    ...
    "git:// github.com/scriptdev2/scriptdev2-classic.git"   // used for fetch if present
};
