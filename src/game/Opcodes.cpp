...
void Opcodes::BuildOpcodeList()
{
    ...
    StoreOpcode(CMSG_WARDEN_DATA,                  "CMSG_WARDEN_DATA",                 STATUS_AUTHED,  PROCESS_THREADUNSAFE, &WorldSession::HandleWardenDataOpcode);      /// 0x2E7: @TODO need to check usage in vanilla WoW
